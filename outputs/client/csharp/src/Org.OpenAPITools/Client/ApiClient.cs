...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://example.com/api/v0");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://example.com/api/v0).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://example.com/api/v0")
        {
