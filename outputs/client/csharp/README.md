# Org.OpenAPITools - the C# library for the OpenAPI Tutorial
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**OpenapitutorialControllerHealthCall**](docs/DefaultApi.md#openapitutorialcontrollerhealthcall) | **GET** /health | サーバーの状態を返します


## Documentation for Models

 - [Model.GetHealthResponse](docs/GetHealthResponse.md)
